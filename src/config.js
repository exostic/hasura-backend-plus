...
exports.HASURA_GRAPHQL_JWT_SECRET = process.env.HASURA_GRAPHQL_JWT_SECRET ? JSON.parse(process.env.HASURA_GRAPHQL_JWT_SECRET) : (process.env.HASURA_GRAPHQL_JWT_PRIVATE_KEY_TYPE && process.env.HASURA_GRAPHQL_JWT_PRIVATE_KEY_VALUE) ?  {'type':process.env.HASURA_GRAPHQL_JWT_PRIVATE_KEY_TYPE, 'key': process.env.HASURA_GRAPHQL_JWT_PRIVATE_KEY_VALUE} : {'type':'HS256', 'key': 'hasura_secretkey'} ;
